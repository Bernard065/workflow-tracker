...
export function ApplicationListHeader({
  ...
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950 p-6 text-white shadow-2xl shadow-slate-950/30 sm:p-8 lg:p-10">
